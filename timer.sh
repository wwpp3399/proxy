#!/bin/bash
proxy=$(curl http://47.116.12.2/getip?num=1&type=1&pro=&city=0&yys=0&port=11&pack=113186&ts=0&ys=0&cs=0&lb=4&sb=0&pb=4&mr=1&regions=&username=chukou01&spec=1)
while true
do
killall mitmdump
killall mitmproxy
